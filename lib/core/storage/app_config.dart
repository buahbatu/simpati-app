...
import 'package:simpati/core/storage/get_storage_wrapper.dart';
import 'package:simpati/core/storage/read_write_value.dart';
...
class AppConfig {
  // TODO: set to false
  static final isDummyOn = false.value('isDummyOn');
